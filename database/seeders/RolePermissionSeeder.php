...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $matrix = [
            ...
            'research-adviser' => ['research.view-assigned', 'proposal.review', 'documents.review', 'documents.download', 'consultations.manage-assigned', 'classes.create', 'classes.view-own', 'classes.manage-join-requests', 'revisions.create', 'revisions.resolve', 'defenses.view', 'evaluations.view-assigned'],
