...
Authentication and student registration are implemented with Blade, Laravel requests/controllers, signed email verification, administrator approval, and Spatie role assignment. See `docs/ACCOUNT_REGISTRATION_AND_RBAC_FLOW.md` before changing the account-access flow.
