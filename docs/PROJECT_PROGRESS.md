...
| Latest completed feature phase | `Phase 17 — Revision Tracker` |
| Current active feature phase | `Phase 18 — Research Progress Milestones (planned)` |
...
> **Baseline note:** Commit `f701324` remains the functional rebuild baseline. Phases 10 through 16 are complete. Phase 13 implemented secure Group Leader submission; `a8320f9` corrected the Phase 14 group-ownership/access foundation; `ab529a5` refined Research Class Group and Group Leader presentation; `173e8f2` completed the secure Research Repository; `5aa438f` completed Adviser Document Review; and Phase 16 completed auditable Consultation Records.
