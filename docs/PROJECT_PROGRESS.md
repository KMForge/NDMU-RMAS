...
> **Baseline note:** Commit `f701324` remains the functional rebuild baseline. Feature modules are being reconnected one phase at a time. Phases 10 through 14 are now complete. Commit `dccec86` refined the completed Phase 12 Adviser My Classes workflow, `ede6384` standardized dashboard sidebar/feature-banner presentation, Phase 13 implemented secure Group Leader submission, and Phase 14 completed the group-owned research repository.
...
### Phase 14 Research Repository — uncommitted working tree
