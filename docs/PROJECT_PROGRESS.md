...
| Phase 19 | Official Research Forms | In Progress | Added the authoritative saved-instance workspace, immutable draft/submission versioning, institutional-template printing from saved versions, secure class-actor and instance-actor management, permission-filtered form navigation, server-derived identities, and auditable academic actions. Strictly implemented forms: 7/25 (RES-040/041/043A/043B/045/046/047); RES-029 awaits a verified template, RES-036 awaits Phase 21, and RES-037 awaits Phases 21/22. Weighted progress is approximately 84%. See `PHASE_19_OFFICIAL_RESEARCH_FORMS.md`. |
