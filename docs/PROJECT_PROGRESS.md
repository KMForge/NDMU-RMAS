...
| Phase 19 | Official Research Forms | In Progress | Implemented Phase 19A RBAC Form Permission catalog (`forms.<form-code>.<action>`), default specialist roles (`research-instructor`, `language-editor`, `technical-editor`, `instrument-validator`), definition-derived form_code, portable catalog tables, and `SyncOfficialFormCatalog` action. Verified by `FormPermissionsTest` (5 tests, 16 assertions, 0 failures), Pint, and Vite production build. |
