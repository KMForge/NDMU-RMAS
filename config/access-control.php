...
return [
    ...
    'roles' => [
        ...
        'thesis-adviser' => [
            ...
            'user_type' => 'faculty',
            'permissions' => ['dashboards.adviser.view', 'classes.serve-as-adviser', 'research.view-assigned', 'progress.view-assigned', 'proposal.review', 'documents.upload', 'documents.review', 'documents.download', 'consultations.manage-assigned', 'revisions.create', 'revisions.resolve', 'defenses.view', 'evaluations.view-assigned', 'classes.view-assigned', 'forms.res-026.view', 'forms.res-026.approve', 'forms.res-027.view', 'forms.res-027.respond', 'forms.res-031.view', 'forms.res-031.sign', 'forms.res-032.view', 'forms.res-032.sign', 'forms.res-033.view', 'forms.res-033.endorse', 'forms.res-034.view', 'forms.res-035.view', 'forms.res-035.record', 'forms.res-038.view', 'forms.res-040.view', 'forms.res-040.endorse', 'forms.res-042.view', 'forms.res-044.view', 'forms.res-044.endorse', 'forms.res-048.view', 'forms.res-049.view'],
        ],
        'panel-member' => [
            'label' => 'Panel Member',
        ...
        'department-chair' => [
            ...
            'user_type' => 'faculty',
            'permissions' => ['dashboards.dean.view', 'research.view-college', 'research.approve', 'proposal.approve', 'documents.download', 'defenses.view', 'evaluations.view-assigned', 'reports.view', 'forms.res-047.view', 'forms.res-047.endorse'],
        ],
        'dean' => [
            'label' => 'Dean',
            'description' => 'Provides college-level research oversight, approval, and reporting.',
            'user_type' => 'faculty',
            'permissions' => ['dashboards.dean.view', 'research.view-college', 'research.approve', 'proposal.approve', 'documents.download', 'defenses.view', 'evaluations.view-assigned', 'reports.view', 'reports.export', 'forms.res-047.view', 'forms.res-047.endorse'],
        ],
        'research-instructor' => [
    ...
    */
    'permissions' => [
        ...
        'Official Research Forms' => [
            ...
            'forms.res-026.approve' => ['label' => 'Approve RES-026 Title Approval', 'description' => 'Sign and approve Title Approval.', 'scope' => 'Assigned scope'],
