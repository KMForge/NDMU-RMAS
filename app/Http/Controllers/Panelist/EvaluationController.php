...
class EvaluationController extends Controller
{
    ...
    {
        $data = $request->validate([
            'research_quality_score' => ['required', 'numeric', 'min:0', 'max:100'],
            'originality_score' => ['required', 'numeric', 'min:0', 'max:100'],
            'relevance_score' => ['required', 'numeric', 'min:0', 'max:100'],
            'general_comments' => ['nullable', 'string', 'max:5000'],
            'recommendations' => ['nullable', 'string', 'max:5000'],
            'student_scores' => ['required', 'array'],
            'student_scores.*.communication_score' => ['required', 'numeric', 'min:0', 'max:100'],
            'student_scores.*.organization_score' => ['required', 'numeric', 'min:0', 'max:100'],
            'student_scores.*.effectiveness_score' => ['required', 'numeric', 'min:0', 'max:100'],
        ]);
