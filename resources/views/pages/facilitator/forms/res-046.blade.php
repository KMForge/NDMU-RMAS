<div x-show="activeOfficialForm === 'RES-046'" x-cloak>
    <x-student-official-form code="RES-Form-046" title="Certificate of Technical Editing" guidebook-page="132">
        ...
        <div class="grid gap-8 pt-8 text-center md:grid-cols-2"><label><input name="res_046_editor_signature" class="w-full text-center"><span class="block font-bold">Technical Editor (Name & Electronic Signature)</span></label><label>Date Edited:<input type="date" name="res_046_edited_at" class="w-full"></label></div>
