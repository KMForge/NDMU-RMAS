<div x-show="activeOfficialForm === 'RES-045'" x-cloak>
    <x-student-official-form code="RES-Form-045" title="Certificate of Language Editing" guidebook-page="131">
        ...
        <div class="grid gap-8 pt-8 text-center md:grid-cols-2"><x-official-signature-field name-field="res_045_editor_printed_name" label="Language Editor" /><label>Date Edited:<input type="date" name="res_045_edited_at" class="w-full"></label></div>
