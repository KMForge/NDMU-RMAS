                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                @foreach ($groupsAssigned as $aGrp)
                                    ...
                                    <div class="bg-white rounded-2xl border border-gray-150 p-6 shadow-sm space-y-4">
                                        <div class="flex justify-between items-start border-b border-gray-100 pb-4">
                                            <div>
                                                <h3 class="font-bold text-gray-850 text-base">{{ $aGrp->name }}</h3>
                                                <p class="text-xs font-medium text-gray-500 mt-0.5">{{ $aClass?->name ?? 'Research Class' }}</p>
                                            </div>
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            @else
                                                <ul class="space-y-1.5 border border-gray-100 rounded-xl p-3 bg-white">
                                                    @foreach ($aMembers as $aMb)
                                                        <li class="text-xs font-bold text-gray-800 flex items-center gap-2">
                                                            <i class="ph ph-user-circle text-gray-400 text-base"></i>
                                                            <span>{{ $aMb->student?->name ?? 'Student' }}</span>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            @endif
