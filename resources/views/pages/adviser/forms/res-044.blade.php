<div x-show="activeOfficialForm === 'RES-044'" x-cloak>
    <x-student-official-form code="RES-Form-044" title="Endorsement of Student Researcher for Data Gathering" guidebook-page="130">
        ...
        <div><strong>Endorsed by:</strong><div class="mt-5 grid gap-6 text-center md:grid-cols-3">@for ($i=1; $i<=3; $i++)<div class="border-t border-[#173c30] pt-1">Panelist {{ $i }}<br><small>(Name & Signature)</small></div>@endfor</div></div>
