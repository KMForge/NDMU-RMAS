<div x-show="activeOfficialForm === 'RES-038'" x-cloak>
    <x-student-official-form code="RES-Form-038" title="Endorsement of Student Researcher/s to Research Adviser" guidebook-page="122">
        ...
        <div class="grid gap-8 pt-8 text-center md:grid-cols-2"><x-official-signature-field name-field="res_038_dean_program_head_name" label="Dean / Program Head" /><x-official-signature-field name-field="res_038_adviser_printed_name" label="Research Adviser Acceptance" /></div>
