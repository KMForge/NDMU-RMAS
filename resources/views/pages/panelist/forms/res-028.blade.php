<div x-show="activeOfficialForm === 'RES-028'" x-cloak>
    <x-student-official-form code="RES-Form-028" title="Invitation to Research Examination Panelist" guidebook-page="103">
        ...
        <div class="grid gap-8 pt-8 text-center md:grid-cols-3"><x-official-signature-field name-field="res_028_program_coordinator_name" label="Program Coordinator" /><x-official-signature-field name-field="res_028_panelist_printed_name" label="Research Panelist Conforme" /><x-official-signature-field name-field="res_028_college_dean_name" label="College Dean" /></div>
