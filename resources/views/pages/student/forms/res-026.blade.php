<div x-show="activeOfficialForm === 'RES-026'" x-cloak><x-student-official-form code="RES-Form-026" title="Research Title Approval" guidebook-page="101">
        ...
        <div class="grid grid-cols-2 gap-x-6 gap-y-4 pt-3 text-center"><div class="border-b border-[#173c30] pb-1 font-bold">Name</div><div class="border-b border-[#173c30] pb-1 font-bold">Signature</div><div class="col-span-2 text-left font-bold">Panel of Examiners:</div>@foreach (['Chairman','Member 1','Member 2'] as $role)<label class="flex items-center gap-2 text-left italic"><span class="shrink-0">{{ $role }}:</span><input type="text" name="panel_names[]" class="min-w-0 flex-1"></label><div class="border-b border-[#173c30] text-xs text-gray-600">Staff signature</div>@endforeach</div>
