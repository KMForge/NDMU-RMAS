...
<header data-site-header class="site-header sticky top-0 z-50 border-b border-[#043d2e]/10 bg-white/90 backdrop-blur-md">
    <div class="mx-auto flex min-h-[76px] max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-2.5 sm:gap-3">
            @if(Route::has('login'))
                <a href="{{ route('login') }}" class="inline-flex items-center justify-center rounded-xl border border-[#043d2e]/20 bg-white px-4 py-2.5 text-xs font-bold text-[#043d2e] transition duration-200 hover:border-[#043d2e]/60 hover:bg-[#edf4f0] hover:shadow-sm sm:px-5 sm:text-sm">
                    Login
                </a>
            @endif
            @if(Route::has('register'))
                <a href="{{ route('register') }}" class="inline-flex items-center justify-center rounded-xl bg-[#043d2e] px-4 py-2.5 text-xs font-bold text-white shadow-md shadow-[#043d2e]/20 transition duration-200 hover:bg-[#075e3d] hover:shadow-lg hover:shadow-[#043d2e]/30 sm:px-5 sm:text-sm">
                    Register
                </a>
            @endif
        </div>
